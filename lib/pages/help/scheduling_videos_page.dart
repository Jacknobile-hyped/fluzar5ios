            ...
            child: ListView(
              ...
              children: [
                _buildStep(
                  ...
                  'Start by selecting the video you want to schedule. You can choose from your uploaded videos or upload a new one specifically for scheduling.',
                ),
                _buildStep(
                  theme,
                  2,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildTip(theme, 'Monitor your scheduled posts in the dashboard'),
