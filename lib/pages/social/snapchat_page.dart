    ...
    try {
      ...
      if (snapshot.exists) {
        ...
        final accounts = data.entries
            .where((entry) => entry.value['platform'] == 'snapchat')
            .map((entry) => {
                  'id': entry.key,
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'No Snapchat accounts connected',
                        style: TextStyle(
                          fontSize: 18,
                      ...
                      ElevatedButton.icon(
                        onPressed: () {
                          // TODO: Implement Snapchat account connection
                        },
                        icon: const Icon(Icons.add),
                        label: const Text('Connect Snapchat Account'),
                      ),
                    ],
                  ),
                )
